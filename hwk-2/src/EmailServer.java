        ...
        while(!quit) {
            ...
            switch(message.getParam(EmailProtocolMessage.TYPE_KEY)) {
                case (EmailProtocolMessage.LOGIN_COMMAND):
                    // log in
                    clientWriter.writeBytes(EmailProtocolMessage.TYPE_KEY + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.LOGIN_ACK + 
                        EmailProtocolMessage.PARAM_SEPERATOR + EmailProtocolMessage.STATUS + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.ACK + "\n");
                    break;
                case (EmailProtocolMessage.SEND_EMAIL_COMMAND):
                    // send email
                    clientWriter.writeBytes(EmailProtocolMessage.TYPE_KEY + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.SEND_EMAIL_ACK + 
                        EmailProtocolMessage.PARAM_SEPERATOR + EmailProtocolMessage.STATUS + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.ACK + "\n");
                ...
                case (EmailProtocolMessage.RETRIEVE_EMAIL_COMMAND):
                    ...
                    if (userInbox == null) {
                        clientWriter.writeBytes(EmailProtocolMessage.TYPE_KEY + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.EMAILS_INBOX + 
                            EmailProtocolMessage.PARAM_SEPERATOR + EmailProtocolMessage.EMAILS_INBOX + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.EMAIL_END + "\n");
                    } else {
                        clientWriter.writeBytes(EmailProtocolMessage.TYPE_KEY + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.EMAILS_INBOX + 
                            EmailProtocolMessage.PARAM_SEPERATOR + EmailProtocolMessage.EMAILS_INBOX + EmailProtocolMessage.PARAM_ASSIGN + userInbox + "\n");
                    }
                    break;
                case (EmailProtocolMessage.LOGOUT_COMMAND):
                    // log out
                    clientWriter.writeBytes(EmailProtocolMessage.TYPE_KEY + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.LOGOUT_ACK + 
                        EmailProtocolMessage.PARAM_SEPERATOR + EmailProtocolMessage.STATUS + EmailProtocolMessage.PARAM_ASSIGN + EmailProtocolMessage.ACK + "\n");
                    System.out.println();
                    listen();
                    break;
